    ...
    },
    {
      ...
      content: (
        <div className="flex h-full items-start justify-start p-8 text-left text-[clamp(1.5rem,3vw,2.5rem)] font-medium leading-tight text-black  cursor-pointer">
          <TypewriterText text="EXP." className="relative z-10 text-[clamp(5rem,22vw,18rem)]" />
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex h-full items-end p-8 text-left text-[clamp(1.5rem,3vw,2.5rem)] font-medium leading-tight text-black  cursor-pointer overflow-hidden">
          ...
          >
            <svg
              viewBox="0 0 98 96"
              className="mb-2 h-[clamp(2.5rem,7vw,6rem)] w-[clamp(2.5rem,7vw,6rem)]"
              fill="currentColor"
              aria-hidden="true"
            >
              <path
            ...
            <span className="text-[clamp(3rem,13vw,10rem)] leading-none">GIT<span className="text-[#8534F3]">HUB</span></span>
          </div>
        </div>
      ),
    },
